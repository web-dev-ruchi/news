            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    if (isset($_GET['aid'])) {
                        ...
                        $query3 = "SELECT * FROM post JOIN user 
                  ...
                  ON p.author=u.user_id WHERE p.author={$aid} ORDER BY p.post_id 
                    ...
                    <?php
                        ...
                        <ul class='pagination'>
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                ...
                                echo "
                                <li class='{$active}'><a href='author.php?aid=" . $aid . "&page={$i}'>{$i}</a></li>
                                ";
                            }
                            if ($total_pages > $page) {
                        ...
                        echo "<h1>Record not Found!lkl</h1>";
                    }
                    ?>
                </div><!-- /post-container -->
            </div>
